...
(* We develop theory which establishes properties related to the number of loop-iterations of the
rejection sampling algorithm. These will later be used for proofs of leakage-freeness.   *)
