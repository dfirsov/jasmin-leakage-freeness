...
(* We define leakage function (samp_t) and prove that it correctly computes
leakages of the rejection sampling algorithm.  *)
...
lemma rsample_leakages l :
  hoare [ M(Syscall).bn_rsample_i : M.leakages = l
