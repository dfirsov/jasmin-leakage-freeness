...
(* We instantiate rejection sampling algorithm to uniform sampling. We also relate
high-level RS.sample to Jasmin's specification algorithm CSpecFP.rsample  *)
